...
export const Lead = ({
  ...
  return (
    <>
      <Card
        className={`m-auto mt-3 bg-light radius-10 border-0 mx-4 ${
          props.glowingCard &&
          props.keyRef == item._id &&
                ...
                <Row>
                  ...
                  <Col dir="ltr" className="top-16 ms-2 ">
                    <Button
                      ...
                      className="button--green background--green border-0 radius-10 p-1"
                    >
          ...
          <Card.Text className="m-0 p-0 d-flex align-items-start w-100">
            {activeId === item._id && editLoading ? (
              ...
              <Button
                ...
                className="button--green fs-6 fw-bold background--green border-0 w-100 mt-3"
                size="lg"
                type="submit"
                block
              >
