...
export const FreeOrder = (props) => {
    ...
    let editLoading = useSelector(state => state.editSaleOpportunitySellerStatus.loading)
    ...
    const formHandler = (e) => {
        e.preventDefault()
        dispatch(orderActions.editSaleOpportunitySellerStatus({orderId: props.order, status: props.status}))
    }
