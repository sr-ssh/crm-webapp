                ...
                <Form onSubmit={formHandler} >
                    ...
                    <Row>
                        <Col>
                            ...
                            <input type="file" className={`d-flex flex-row w-100 align-items-center justify-content-center btn--add--note--desktop radius-16 receipt--add--note  py-4 upload--file--input pe-0`} onChange={e => {console.log(e.target.files[0]);setFile(e.target.files[0]);}} title="آدرس فایل را مشخص کنید"/>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
