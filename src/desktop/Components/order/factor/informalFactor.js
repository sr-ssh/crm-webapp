...
export const InformalFactor = ({ factor }) => {
  ...
  return (
    <Container
      fluid
      className="factor--page--desktop d-flex flex-column align-items-center"
    >
      <Row className="w-100 mt-5 d-flex justify-content-around ">
        <Col className="me-5 d-flex align-items-center">
          <span className="fw-bold fs-5">
            {factor.status == 3 ? "پیش فاکتور" : "فاکتور"}
          </span>
          <span className="me-3 fw-bold fs-6 text--dark--blue">غیر رسمی</span>
        </Col>
            ...
            <Card.Body>
              <Row className="d-flex mx-3 my-2">
                <Col className="d-flex align-items-center">
                  <span className="fw-bold fs-7">تلفن :</span>
                ...
                <Col className="d-flex align-items-center pe-5">
                  ...
                  <span className="text--gray--factor--desktop me-3 ">
                    {factor.createdAt &&
                      persianJs(
                        moment
                          .from(factor.customer.createdAt, "YYYY/MM/DD")
                          .locale("fa")
                          .format("YYYY/MM/DD")
                      )
                        .englishNumber()
          ...
          <Table bordered className="table--factor--desktop">
            <thead>
              <tr>
                ...
                <th className="py-4  px-0 fs-7 text-center w-50 text-nowrap">
                  شرح کالا یا خدمات
                </th>
                <th className="py-4  fs-7 text-center px-1">تعداد</th>
                <th className="py-4  fs-7 text-center px-5 text-nowrap">
                  مبلغ واحد (ریال)
                </th>
                <th className="py-4  fs-7 text-center px-5 text-nowrap">
                  تخفیف (ریال)
            ...
            <tbody className="border border-blue">
              ...
              <tr className=" footer--table--factor--desktop">
                ...
                <td className="py-3 text-end pe-5" colSpan="4">
                  <span className="text--gray--factor--desktop me-5 pe-5">
                    {getTotalPrice(factor.products) &&
                      persianJs(getTotalPrice(factor.products))
                        .englishNumber()
                        .toString()}{" "}
                  </span>
                </td>
