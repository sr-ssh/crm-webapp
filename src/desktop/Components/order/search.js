...
export const OrderSearch = (props) => {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name == "customerMobile")
      e.target.value = e.target.value && persianJs(e.target.value).toEnglishNumber().toString();
            ...
            <Col className="col-6 order-filter-input">
              <Form.Group className="ms-2">
                ...
                <DatePicker
                  ...
                  editable={false}
                  animation
                  onChange={(value) => submitCalendar(value, "startTrackingTime")}
                />
              </Form.Group>
            </Col>
            <Col className="col-6 order-filter-input">
              <Form.Group className="me-2">
                ...
                <DatePicker
                  ...
                  editable={false}
                  animation
                  onChange={(value) => submitCalendar(value, "endTrackingTime")}
                />
              </Form.Group>
            </Col>
          </Row>
