...
export const EditeProductOrder = (props) => {
  ...
  const [inputCurrentPriceProduct, setInputCurrentPriceProduct] =
    useState(false);
  const [
    inputCurrentPriceProductValidation,
    setInputCurrentPriceProductValidation,
  ] = useState(false);
  ...
  let editPriceProduct = (e, product) => {
    ...
    else setInputCurrentPriceProductValidation(false);
  ...
  let removeOrder = (e, product) => {
    ...
    if (order.length == 1)
      return dispatch(
        alertActions.error("کمتر از یک کالا در سبد خرید مجاز نیست")
      );
                ...
                <Card.Body className="p-0 basket-flex">
                  <Row className="m-0 p-0 mt-2 justify-content-evenly">
                      ...
                      >
                        ...
                        >
                          ...
                          <img
                            ...
                            alt="spinner-icon"
                            style={{
                              transform: dimStatus ? "rotate(180deg)" : null,
                            }}
                          />
                        </Dropdown.Toggle>
                        <Dropdown.Menu
                    ...
                    <Col className="m-0 p-0 text-center products-add-btn d-flex justify-content-end">
                      <Button
                        className="products-add--desktop border-0 py-1 w-75  "
                  ...
                  <Row className="pt-2 pe-2">
                    <div
                      className="table-wrapper-scroll-y my-custom-scrollbar px-1"
                      style={{ height: "31vh" }}
                    >
                                      ...
                                      <>
                                        <td className="px-0">
                                          <img
                                            src={editIcon}
                                            onClick={(e) => {
                                              setEditPriceCurrentProduct(true);
