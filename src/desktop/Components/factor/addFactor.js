        ...
        <Container fluid className="pt-3 px-3 m-0">
          ...
          >
            ...
            >
              ...
              <Row className="col-12 m-0 mt-4 pt-3 basketContainer">
                <Col>
                  <Basket
                    order={order}
              ...
              <Row className="m-0 p-0 mt-4">
                <Col className="mt-3 w-100">
                  <Button
                    className={`d-flex flex-row w-100 align-items-center justify-content-center btn--add--note--desktop radius-16 `}
                    onClick={noteHandler}
                  >
                    {notes.length > 0 ? (
                      <>
                      ...
                      <>
                        <img
                          ...
                          alt="edit-icon"
                        />
                        <span className="me-3 fw-bold ms-3">اضافه یادداشت</span>
                      </>
                    )}
                  </Button>
                </Col>
