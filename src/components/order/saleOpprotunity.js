                ...
                <Card className={`m-auto mt-3 bg-light productCard border-0 lh-lg ${!print ? 'noPrint' : ''}`} >
                    <Card.Body className="pb-0 px-2 rounded-3 text-gray">
                        ...
                        <Row className="p-0 m-0 pb-3 w-100">
                            <Col xs={6} className="p-0 px-1">
                                <Button className="w-100 btn-outline-dark btn--sale--opprotunity p-1 border-0 noPrint py-2 pe-2" type="button">
                                    <img src={editeOrderIcon} height="25px" alt="edit-order-icon" className="px-2 col-3 py-1" />
                                    <span>تغییر</span>
                                </Button>
                            </Col>
                            <Col xs={6} className="p-0 px-1">
                        ...
                        <Row className="p-0 m-0 pb-3 w-100">
                            <Col xs={6} className="p-0 px-1">
                                <Button className="w-100 btn-outline-dark btn--sale--opprotunity p-1 border-0 noPrint py-2 pe-2" type="button">
                                    <img src={editeOrderIcon} height="25px" alt="edit-order-icon" className="px-1 col-3" />
                                    <span>ثبت</span>
                                </Button>
                            </Col>
                            <Col xs={6} className="p-0 px-1">
                                <Button className="w-100 btn-outline-dark btn--sale--opprotunity p-1 border-0 noPrint py-2 pe-2" type="button">
                                    <img src={printIcon} height="25px" alt="edit-order-icon" className="px-1 col-3 py-1" />
                                    <span>چاپ</span>
                                </Button>
                            </Col>
                        </Row>
