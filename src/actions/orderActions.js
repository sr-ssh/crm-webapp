...
function editOrderStatus(orderId, status) {
  return (dispatch) => {
    dispatch(request());
    orderService.editOrderStatus(orderId, status).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          ...
          dispatch(
            failure(orderConstants.EDIT_ORDER_STATUS_FAILURE, res.message)
          );
      ...
      (error) => {
        dispatch(
          failure(orderConstants.EDIT_ORDER_STATUS_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
  ...
  function request() {
    ...
    return { type: orderConstants.EDIT_ORDER_STATUS_REQUEST };
  }
  function success() {
    console.log("into success");
    return { type: orderConstants.EDIT_ORDER_STATUS_SUCCESS };
  }
  function failure(error) {
    return { type: orderConstants.EDIT_ORDER_STATUS_FAILURE, error };
  }
}
...
function editOrderPrice(orderId, productId, status) {
  return (dispatch) => {
    ...
    orderService.editOrderPrice(orderId, productId, status).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(failure("ارتباط با سرور برقرار نمیباشد"));
      ...
      (error) => {
        dispatch(
          failure(orderConstants.EDIT_ORDER_PRICE_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function editOrderQuantity(orderId, productId, status) {
  return (dispatch) => {
    ...
    orderService.editOrderQuantity(orderId, productId, status).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(failure("ارتباط با سرور برقرار نمیباشد"));
          ...
          console.log("order status changed");
          dispatch(
            success(orderConstants.EDIT_ORDER_QUANTITY_SUCCESS, res.data)
          );
          dispatch(alertActions.success(res.message));
        }
      ...
      (error) => {
        dispatch(
          failure(orderConstants.EDIT_ORDER_QUANTITY_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function editProductOrder(params) {
  return (dispatch) => {
    ...
    orderService.editProductOrder(params).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(failure("ارتباط با سرور برقرار نمیباشد"));
          ...
          console.log("order status changed");
          dispatch(
            success(orderConstants.EDIT_PRODUCT_ORDER_SUCCESS, res.data)
          );
          dispatch(alertActions.success(res.message));
        }
      ...
      (error) => {
        dispatch(
          failure(orderConstants.EDIT_PRODUCT_ORDER_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function cancelProductOrder(orderId, productId) {
  ...
  return (dispatch) => {
    ...
    orderService.cancelProductOrder(orderId, productId).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(failure("ارتباط با سرور برقرار نمیباشد"));
          ...
          console.log("product order changed");
          dispatch(
            success(orderConstants.CANCEL_PRODUCT_ORDER_SUCCESS, res.data)
          );
          dispatch(alertActions.success(res.message));
        } else if (res.success === false) {
          console.log("product order changed");
          dispatch(
            failure(orderConstants.CANCEL_PRODUCT_ORDER_FAILURE, res.message)
          );
          dispatch(alertActions.error(res.message));
        }
      },
      (error) => {
        dispatch(
          failure(orderConstants.CANCEL_PRODUCT_ORDER_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function addOrder(products, customer, seller, notes, force = 0, reminder) {
  return (dispatch) => {
    dispatch(request());
    orderService
      .addOrder(products, customer, seller, notes, force, reminder)
      .then(
        (res) => {
          console.log(res);
          if (res === undefined) {
  ...
  function request() {
    console.log("into request");
    return { type: orderConstants.ADD_ORDER_REQUEST };
  }
  function success(order) {
    console.log("into success");
    return { type: orderConstants.ADD_ORDER_SUCCESS, order };
  }
  function failure(error) {
    return { type: orderConstants.ADD_ORDER_FAILURE, error };
  }
}
...
function editSms(params) {
  return (dispatch) => {
    ...
    Object.values(params).map((item) =>
      orderService.editOrderSms(item).then(
        (res) => {
          console.log(res);
          if (res === undefined) {
            dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
  ...
  function request(params) {
    console.log("into request");
    return { type: orderConstants.EDIT_SETTING_SMS_REQUEST, params };
  }
  function success() {
    console.log("into success");
    return { type: orderConstants.EDIT_SETTING_SMS_SUCCESS };
  }
  function failure(error) {
    return { type: orderConstants.EDIT_SETTING_SMS_FAILURE, error };
  }
}
...
function getSms() {
  ...
  function request() {
    console.log("into request");
    return { type: orderConstants.GET_SETTING_SMS_REQUEST };
  }
  function success(sms) {
    console.log("into success");
    return { type: orderConstants.GET_SETTING_SMS_SUCCESS, sms };
  }
  function failure(error) {
    return { type: orderConstants.GET_SETTING_SMS_FAILURE, error };
  }
}
...
function sendDeliverySms(data) {
  return (dispatch) => {
    ...
    orderService.sendDeliverySms(data).then(
      (res) => {
        if (res === undefined)
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
        else if (res.success) {
      ...
      (error) => {
        dispatch(
          failure(orderConstants.SEND_ORDER_SMS_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function orderDetails(params) {
  return (dispatch) => {
    ...
    orderService.orderDetails(params).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          ...
          dispatch(alertActions.error(res.message));
          dispatch(
            failure(orderConstants.GET_ORDER_DETAILS_FAILURE, res.message)
          );
        }
      },
      (error) => {
        dispatch(
          failure(orderConstants.GET_ORDER_DETAILS_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function getShareLinkOrder(params) {
  return (dispatch) => {
    ...
    orderService.getShareLinkOrder(params).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.GET_ORDER_SHARE_LINK_FAILURE,
          ...
          dispatch(
            failure(orderConstants.GET_ORDER_SHARE_LINK_FAILURE, res.message)
          );
          dispatch(alertActions.error(res.message));
        }
      },
      (error) => {
        dispatch(
          failure(orderConstants.GET_ORDER_SHARE_LINK_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
...
function confirmFinancial(orderId) {
  return (dispatch) => {
    ...
    orderService.confirmFinancial(orderId).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.CONFIRM_FINANCIAL_ORDER_FAILURE,
              "ارتباط با سرور برقرار نیست"
            )
          );
        } else if (res.success) {
          ...
          dispatch(
            success(orderConstants.CONFIRM_FINANCIAL_ORDER_SUCCESS, res.data)
          );
        } else if (res.success == false) {
          dispatch(
            failure(orderConstants.CONFIRM_FINANCIAL_ORDER_FAILURE, res.message)
          );
          dispatch(alertActions.error(res.message));
        }
      },
...
function uploadDoc(orderId) {
  return (dispatch) => {
    ...
    orderService.uploadDoc(orderId).then(
      (res) => {
        console.log(res);
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.UPLOAD_DOC_FAILURE,
              "ارتباط با سرور برقرار نیست"
            )
          );
        } else if (res.success) {
...
function showDoc(orderId) {
  return (dispatch) => {
    ...
    orderService.showDoc(orderId).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.SHOW_DOC_FAILURE,
              "ارتباط با سرور برقرار نیست"
            )
          );
        } else if (res.success) {
...
function editSaleOpportunitySellerStatus(orderId) {
  return (dispatch) => {
    dispatch(request(orderConstants.CONFIRM_FINANCIAL_ORDER_REQUEST));
    orderService.editSaleOpportunitySellerStatus(orderId).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
...
function orderSupport(params) {
  return (dispatch) => {
    ...
    orderService.orderSupport(params).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.GET_SUPPORT_ORDER_FAILURE,
              "ارتباط با سرور برقرار نیست"
            )
          );
        } else if (res.success) {
          ...
          dispatch(
            failure(orderConstants.GET_SUPPORT_ORDER_FAILURE, res.message)
          );
          dispatch(alertActions.error(res.message));
        }
      },
      (error) => {
        dispatch(
          failure(orderConstants.GET_SUPPORT_ORDER_FAILURE, error.toString())
        );
        console.log("occure error");
        console.log(error.toString());
        dispatch(alertActions.error(error.toString()));
    ...
    orderService.failSaleOpportunity(params).then(
      (res) => {
        if (res === undefined) {
          ...
          console.log("order financial confirmed");
          dispatch(
            success(orderConstants.FAIL_SALE_OPPORTUNITY_SUCCESS, res.data)
          );
        } else if (res.success == false) {
          dispatch(
...
function addTrackingCode(params) {
  return (dispatch) => {
    ...
    orderService.addTrackingCode(params).then(
      (res) => {
        if (res === undefined) {
          dispatch(alertActions.error("ارتباط با سرور برقرار نیست"));
          dispatch(
            failure(
              orderConstants.ADD_ORDER_TRACKING_CODE_FAILURE,
              "ارتباط با سرور برقرار نیست"
            )
          );
        } else if (res.success) {
          ...
          dispatch(
            success(orderConstants.ADD_ORDER_TRACKING_CODE_SUCCESS, res.data)
          );
          setTimeout(() => {
          ...
          dispatch(
            failure(orderConstants.ADD_ORDER_TRACKING_CODE_FAILURE, res.message)
          );
          dispatch(alertActions.error(res.message));
        }
      },
    ...
    orderService.editPriority(body).then(
      (res) => {
        if (res === undefined) {
          ...
          dispatch(failure(orderConstants.EDIT_PRIORITY_FAILURE, res.message));
          dispatch(alertActions.error(res.message));
        }
      },
      (error) => {
