...
export const EditProduct = (props) => {
  ...
  let handleChange = (e) => {
    ...
    if (id === "name") value = productnameHandler(value);
    // product sellingPrice validation
    if (id === "sellingPrice" && value.length) {
      value = persianJs(value).toEnglishNumber().toString();
    }
    if (id === "active1") setnewProduct({ ...newProduct, active: true });
    else if (id === "active0") setnewProduct({ ...newProduct, active: false });
  ...
  let formHandler = (e) => {
    ...
    if (newProduct.name && newProduct.sellingPrice) {
      dispatch(productActions.editProduct({...newProduct, checkWareHouse, direct }));
      setCheckWareHouse(0);
      setDirect(0);
  ...
  useEffect(() => {
    ...
    setDirect(!!props.product.ingredients?.length);
    setCheckWareHouse(props.product.checkWareHouse);
  }, [props.product]);
      ...
      <Modal.Body className="add-product px-4">
        ...
        <Form onSubmit={formHandler}>
          <Row className="my-3 mb-4 justify-content-center">
            <Col className="ms-3">
              <Form.Group
                className="fw-bold product-checkbox"
              ...
              >
                <Form.Check.Input
                  ...
                  isValid
                />
                <Form.Check.Label htmlFor="active1" inline className="me-1">
                  فعال
                </Form.Check.Label>
              </Form.Group>
            </Col>
            <Col>
              ...
              >
                <Form.Check.Input
                  ...
                  isInvalid
                />
                <Form.Check.Label htmlFor="active0" inline className="me-1">
                  غیر فعال
                </Form.Check.Label>
              </Form.Group>
            </Col>
            ...
            <Col className="col-6 order-filter-input">
              <Form.Group controlId="name">
                ...
                <Form.Control
                  ...
                  onChange={handleChange}
                  isInvalid={
                    (!newProduct.name && validated) ||
                    (productnameValidated && true)
                  }
                  isValid={
                    (newProduct.name && validated) ||
                    (productnameValidated && newProduct.name && true)
                  }
                />
              </Form.Group>
            </Col>
            <Col className="col-6 order-filter-input">
              <Form.Group controlId="sellingPrice">
                ...
                <Form.Control
                  ...
                  onChange={handleChange}
                  isInvalid={
                    (!newProduct.sellingPrice && validated) ||
                    (productpriceValidated && true)
                  }
                  isValid={
                    (newProduct.sellingPrice && validated) ||
                    (productpriceValidated && newProduct.sellingPrice && true)
                  }
                />
              </Form.Group>
            </Col>
          ...
          <Row>
            <Col>
              ...
              >
                ...
                <Form.Control
                  className="order-input border-0 h-100"
                  as="textarea"
