                    ...
                    <Row>
                        <Col>
                            <Form.Group controlId="description" className="order-filter-input mt-3">
                                ...
                                <Form.Control className="order-input--description border-0 h-100" as="textarea" defaultValue={props.product.description} rows={3} onChange={handleChange} />
                            </Form.Group>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                            {
                                editProductLoading ? (
                                    <Button className="fs-6 receipt--btn--mobile border-0 w-100 mt-4" size="lg" type="submit" disabled>
                                        <Spinner
                                            as="span"
                                            animation="grow"
                                            size="sm"
                                    ...
                                    <Button className="fs-6 receipt--btn--mobile border-0 w-100 mt-4 " size="lg" type="submit" block>
                                        ویرایش کردن
                                    </Button>
                                )
                            }
