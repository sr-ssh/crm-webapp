...
export const EmployerRegister = () => {
  ...
  const handleChange = (e) => {
    ...
    if (id === "mobile") value = mobileHandler(value);
  ...
  return (
    <div className="form-page">
      ...
      <Container fluid className="p-0 d-flex flex-column mt-5">
        {alertMessage && (
          <>
            ...
            >
              ...
              <Row className="w-100 me-2 pe-2 form-label mt-2">
                ...
                <Col className="mt-auto col-3">
                  <Button
                    className="verification-btn fs-6-sm px-0"
                    onClick={codeHandler}
                  >
              ...
              <Row>
                <Col>
                  <Button
                    className="register-submit-btn m-auto d-block"
                    type="submit"
                  >
                    {registerLoading ? (
